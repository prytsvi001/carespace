...
import {
  ISSUE_TYPES, IssueTypeValue, IssueTypeBadge, ChatRefDisplay,
  computeIssueStats, AgentStatsGrid, QAReportPreview,
} from '../components/qaReport';
...
function agentStats(issues: QAIssue[], agentId: string, totalChats: number | null) {
  return computeIssueStats(issues.filter((i) => i.agentId === agentId), totalChats);
}

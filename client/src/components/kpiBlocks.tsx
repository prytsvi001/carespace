...
import { Section, parseBoldSections, SectionedContent } from './sectionedContent';

// ─── Обов'язки — accordion (shared with Onboarding's block content) ──────
function DutiesAccordion({ content }: { content: string }) {
  return <SectionedContent content={content} />;
}

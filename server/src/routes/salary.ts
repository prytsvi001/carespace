...
// only to head (Sandra Moore). Auto-pulls hours (Statistics), reviews
// (Reviews tab), and Julia's resolved Peek Requests count; everything is
// overridable and persisted per person per month in SalaryRecord.
